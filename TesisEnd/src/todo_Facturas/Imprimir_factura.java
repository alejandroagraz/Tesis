...
public class Imprimir_factura extends Thread {
    ...
    parametros.put("titulo","NOTA DE ENTREGA");
	...
	vuelto=vuelto.subtract(total).setScale(2,RoundingMode.HALF_EVEN);
     ...
     exporter.setParameter(JRExporterParameter.OUTPUT_FILE, new java.io.File("Reportes" + Inicio.url_sistema + "nota_entrega.pdf")); 
     exporter.exportReport(); 
 
     
     
		File archivo=new File("Reportes" + Inicio.url_sistema + "nota_entrega.pdf");
